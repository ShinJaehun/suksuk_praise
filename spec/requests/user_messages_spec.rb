...
RSpec.describe 'User messages', type: :request do
  ...
  describe 'teacher/admin root messages and student replies' do
    ...
    it 'shows a teacher root and student replies in the same thread card' do
      ...
      create(:user_message, classroom: classroom, sender: student, recipient: teacher, parent_message: root,
                            body: '학생 댓글')
      sign_in student
    ...
    it 'rejects a reply to another reply' do
      ...
      reply = create(:user_message, classroom: classroom, sender: student, recipient: teacher, parent_message: root,
                                    body: '첫 답글')
      sign_in student
